...
// mouse input
AAPI b8 input_is_button_down(buttons button);
AAPI b8 input_is_button_up(buttons button);
AAPI b8 input_was_button_down(buttons button);
AAPI b8 input_was_button_up(buttons button);
