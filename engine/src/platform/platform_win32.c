...
b8 platform_startup(
    ...
    wc.hIcon = icon;
    wc.hCursor = LoadCursor(0, IDC_ARROW); // NULL; // Manage the cursor manually
    wc.hbrBackground = NULL;               // Transparent
    wc.lpszClassName = "aurorae_window_class";
    ...
    HWND handle = CreateWindowExA(
        window_ex_style, "aurorae_window_class", application_name,
...
void platform_shutdown (platform_state *plat_state) {
    // Simply cod-cast to the known type.
    internal_state *state = (internal_state *)plat_state->internal_state;
...
LRESULT CALLBACK win32_process_message(HWND hwnd, u32 msg, WPARAM w_param, LPARAM l_param) {
    switch (msg) {
        ...
        case WM_RBUTTONUP: {
            ...
            // Pass over to the input subsystems
